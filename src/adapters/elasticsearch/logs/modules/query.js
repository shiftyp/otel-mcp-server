...
var LogQueryModule = /** @class */ (function () {
     ...
     */
    LogQueryModule.prototype.queryLogs = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        logger_js_1.logger.info('[ES Adapter] queryLogs called');
                        _e.label = 1;
                    case 1:
                        _e.trys.push([1, 3, , 4]);
                        indexPattern = '.ds-logs-*,logs*,*logs*,otel-logs*';
                        // Add default sort by timestamp if not specified
                        if (!query.sort) {
                            query.sort = [{ '@timestamp': { order: 'desc' } }];
                        }
                        // Execute the query
                        logger_js_1.logger.debug('[ES Adapter] Executing direct log query', {
                    ...
                    case 2:
                        ...
                        logger_js_1.logger.info('[ES Adapter] Log query returned results', {
                    ...
                    case 3:
                        error_1 = _e.sent();
                        logger_js_1.logger.error('[ES Adapter] Error executing log query', { error: error_1 });
                        throw error_1;
     ...
     */
    LogQueryModule.prototype.countLogs = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            var indexPattern, countQuery, response, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        logger_js_1.logger.info('[ES Adapter] countLogs called');
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        indexPattern = '.ds-logs-*,logs*,*logs*,otel-logs*';
                        countQuery = { query: query.query };
                        logger_js_1.logger.debug('[ES Adapter] Executing log count query');
                        return [4 /*yield*/, this.esCore.callEsRequest('POST', "".concat(indexPattern, "/_count"), countQuery)];
                    case 2:
                        response = _a.sent();
                        // Return the count
                        logger_js_1.logger.info('[ES Adapter] Log count query returned', { count: response.count });
                        return [2 /*return*/, response.count || 0];
                    case 3:
                        error_2 = _a.sent();
                        logger_js_1.logger.error('[ES Adapter] Error executing log count query', { error: error_2 });
                        return [2 /*return*/, 0];
                    case 4: return [2 /*return*/];
                }
            });
     ...
     */
    LogQueryModule.prototype.sampleLogs = function () {
        return __awaiter(this, arguments, void 0, function (size) {
            var query;
            if (size === void 0) { size = 10; }
            return __generator(this, function (_a) {
                logger_js_1.logger.info('[ES Adapter] sampleLogs called', { size: size });
                query = {
                    size: size,
                    query: {
                        function_score: {
                ...
                return [2 /*return*/, this.queryLogs(query)];
            });
        });
    };
    return LogQueryModule;
}());
exports.LogQueryModule = LogQueryModule;
